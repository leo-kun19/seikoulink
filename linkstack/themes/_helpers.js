// Shared helpers for theme renderers
...
const BRAND_SVG = {
  ...
  telegram: '<svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20"><path d="M11.944 0A12 12 0 000 12a12 12 0 0012 12 12 12 0 0012-12A12 12 0 0012 0a12 12 0 00-.056 0zm4.962 7.224c.1-.002.321.023.465.14a.506.506 0 01.171.325c.016.093.036.306.02.472-.18 1.898-.962 6.502-1.36 8.627-.168.9-.499 1.201-.82 1.23-.696.065-1.225-.46-1.9-.902-1.056-.693-1.653-1.124-2.678-1.8-1.185-.78-.417-1.21.258-1.91.177-.184 3.247-2.977 3.307-3.23.007-.032.014-.15-.056-.212s-.174-.041-.249-.024c-.106.024-1.793 1.14-5.061 3.345-.479.33-.913.49-1.302.48-.428-.008-1.252-.241-1.865-.44-.752-.245-1.349-.374-1.297-.789.027-.216.325-.437.893-.663 3.498-1.524 5.83-2.529 6.998-3.014 3.332-1.386 4.025-1.627 4.476-1.635z"/></svg>',
  ...
  discord: '<svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20"><path d="M20.317 4.3698a19.7913 19.7913 0 00-4.8851-1.5152.0741.0741 0 00-.0785.0371c-.211.3753-.4447.8648-.6083 1.2495-1.8447-.2762-3.68-.2762-5.4868 0-.1636-.3933-.4058-.8742-.6177-1.2495a.077.077 0 00-.0785-.037 19.7363 19.7363 0 00-4.8852 1.515.0699.0699 0 00-.0321.0277C.5334 9.0458-.319 13.5799.0992 18.0578a.0824.0824 0 00.0312.0561c2.0528 1.5076 4.0413 2.4228 5.9929 3.0294a.0777.0777 0 00.0842-.0276c.4616-.6304.8731-1.2952 1.226-1.9942a.076.076 0 00-.0416-.1057c-.6528-.2476-1.2743-.5495-1.8722-.8923a.077.077 0 01-.0076-.1277c.1258-.0943.2517-.1923.3718-.2914a.0743.0743 0 01.0776-.0105c3.9278 1.7933 8.18 1.7933 12.0614 0a.0739.0739 0 01.0785.0095c.1202.099.246.1981.3728.2924a.077.077 0 01-.0066.1276 12.2986 12.2986 0 01-1.873.8914.0766.0766 0 00-.0407.1067c.3604.698.7719 1.3628 1.225 1.9932a.076.076 0 00.0842.0286c1.961-.6067 3.9495-1.5219 6.0023-3.0294a.077.077 0 00.0313-.0552c.5004-5.177-.8382-9.6739-3.5485-13.6604a.061.061 0 00-.0312-.0286zM8.02 15.3312c-1.1825 0-2.1569-1.0857-2.1569-2.419 0-1.3332.9555-2.4189 2.157-2.4189 1.2108 0 2.1757 1.0952 2.1568 2.419 0 1.3332-.9555 2.4189-2.1569 2.4189zm7.9748 0c-1.1825 0-2.1569-1.0857-2.1569-2.419 0-1.3332.9554-2.4189 2.1569-2.4189 1.2108 0 2.1757 1.0952 2.1568 2.419 0 1.3332-.946 2.4189-2.1568 2.4189z"/></svg>',
  shopee: '<svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20"><path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm0 2.4a4.8 4.8 0 014.8 4.8h-1.6a3.2 3.2 0 00-6.4 0H7.2A4.8 4.8 0 0112 2.4zM5.6 8.4h12.8c.442 0 .8.358.8.8v9.6c0 1.325-1.075 2.4-2.4 2.4H7.2c-1.325 0-2.4-1.075-2.4-2.4V9.2c0-.442.358-.8.8-.8z"/></svg>',
  tokopedia: '<svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 3c1.66 0 3 1.34 3 3s-1.34 3-3 3-3-1.34-3-3 1.34-3 3-3zm0 14.2c-2.5 0-4.71-1.28-6-3.22.03-1.99 4-3.08 6-3.08 1.99 0 5.97 1.09 6 3.08-1.29 1.94-3.5 3.22-6 3.22z"/></svg>',
  email: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="20" height="20"><rect width="20" height="16" x="2" y="4" rx="2"/><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/></svg>',
  globe: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="20" height="20"><circle cx="12" cy="12" r="10"/><path d="M12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 0-20"/><path d="M2 12h20"/></svg>',
...
function getBrandSvg(name) {
  return BRAND_SVG[name] || BRAND_SVG['link'];
}
...
function getIconForLink(link) {
  ...
  return getBrandSvg(iconName);
}

/**
 * Render links with smart grouping:
 * - is_divider becomes section header
 * - adjacent is_social links become icon-row
 * - regular links stay as full-width buttons
 *
 * @param {Array} links - all active links in order
 * @param {Object} options - { renderDivider, renderRegular, renderSocial, socialWrapClass }
 */
function renderGroupedLinks(links, options) {
  const { renderDivider, renderRegular, renderSocial, socialWrapClass } = options;
  let html = '';
  let socialBuffer = [];

  const flushSocial = () => {
    if (socialBuffer.length === 0) return;
    html += `<div class="${socialWrapClass || 'social-row'}">${socialBuffer.map(renderSocial).join('')}</div>`;
    socialBuffer = [];
  };

  for (const link of links) {
    if (link.is_social && !link.is_divider) {
      socialBuffer.push(link);
      continue;
    }
    flushSocial();
    if (link.is_divider) {
      html += renderDivider(link);
    } else {
      html += renderRegular(link);
    }
  }
  flushSocial();
  return html;
...
function buildSeoHead(data) {
  return `<meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>${data.escapeHtml(data.seoTitle)}</title>
  <meta name="description" content="${data.escapeHtml(data.seoDesc)}">
  <meta name="robots" content="${data.indexable ? 'index, follow, max-image-preview:large, max-snippet:-1' : 'noindex, follow'}">
  <meta name="googlebot" content="${data.indexable ? 'index, follow' : 'noindex, follow'}">
  <link rel="canonical" href="${data.profileUrl}">
  <meta property="og:title" content="${data.escapeHtml(data.user.display_name || data.user.username)} - Link in Bio">
  <meta property="og:description" content="${data.escapeHtml(data.seoDesc)}">
  <meta property="og:url" content="${data.profileUrl}">
  <meta property="og:site_name" content="SeikouLink">
  <meta property="og:locale" content="id_ID">
  ${data.ogImageMeta}
  <meta property="og:type" content="profile">
  <meta property="profile:username" content="${data.escapeHtml(data.user.username)}">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="${data.escapeHtml(data.user.display_name || data.user.username)} - Link in Bio">
  <meta name="twitter:description" content="${data.escapeHtml(data.seoDesc)}">
...
module.exports = { buildSeoHead, getInitial, escapeForAttr, getIconForLink, getBrandSvg, detectIcon, renderGroupedLinks };
